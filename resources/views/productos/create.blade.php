                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('productos.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="fecha_compra" class="block mt-1 w-full" type="date" name="fecha_compra" :value="old('fecha_compra')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="descripcion_corta" class="block mt-1 w-full" type="text" name="descripcion_corta" :value="old('descripcion_corta')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="descripcion_larga" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="descripcion_larga" required>{{ old('descripcion_larga') }}</textarea>
